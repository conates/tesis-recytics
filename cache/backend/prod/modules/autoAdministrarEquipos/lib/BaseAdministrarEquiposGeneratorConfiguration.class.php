...
class BaseAdministrarEquiposGeneratorConfiguration extends sfModelGeneratorConfiguration
{
  ...
  {
    return '%%id%% - %%origen%% - %%marca%% - %%peso%% - %%estado%% - %%detalle%% - %%user_id%% - %%categoria_id%% - %%empleado_id%% - %%venta_equipo_id%%';
  }
  ...
  {
    return array(  0 => 'id',  1 => 'origen',  2 => 'marca',  3 => 'peso',  4 => 'estado',  5 => 'detalle',  6 => 'user_id',  7 => 'categoria_id',  8 => 'empleado_id',  9 => 'venta_equipo_id',);
  }
