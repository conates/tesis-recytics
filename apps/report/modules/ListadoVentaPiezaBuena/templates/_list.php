  ...
  <table>
    ...
    <thead class="ui-widget-header">
      <tr>
        ...
        <?php include_partial('ListadoVentaPiezaBuena/list_th_tabular', array('sort' => $sort)) ?>
      ...
      <tr>
        <th colspan="5">
          <div class="ui-state-default ui-th-column ui-corner-bottom">
            <?php include_partial('ListadoVentaPiezaBuena/pagination', array('pager' => $pager)) ?>
          </div>
        </th>
      </tr>
    </tfoot>
    ...
    <tbody>
      <?php foreach ($pager->getResults() as $i => $venta_pieza): $odd = fmod(++$i, 2) ? ' odd' : '' ?>
        <tr class="sf_admin_row ui-widget-content <?php echo $odd ?>">
                      <?php include_partial('ListadoVentaPiezaBuena/list_td_batch_actions', array('venta_pieza' => $venta_pieza, 'helper' => $helper)) ?>
          
          <?php include_partial('ListadoVentaPiezaBuena/list_td_tabular', array('venta_pieza' => $venta_pieza)) ?>

                  </tr>
      <?php endforeach; ?>
    </tbody>
  </table>
	<?php echo link_to("Exportar a Excel","@excelPiezaBuena")?>
  <?php endif; ?>
</div>
