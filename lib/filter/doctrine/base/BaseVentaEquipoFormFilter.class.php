...
/**
 * VentaEquipo filter form base class.
 *
 * @package    tesis
 * @subpackage filter
 ...
 */
abstract class BaseVentaEquipoFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('venta_equipo_filters[%s]');
